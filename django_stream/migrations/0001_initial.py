...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Follow'
        db.create_table(u'django_stream_follow', (
        ...
        db.send_create_signal(u'django_stream', ['Follow'])


    def backwards(self, orm):
        # Deleting model 'Follow'
        db.delete_table(u'django_stream_follow')
    ...
    models = {
        ...
        u'django_stream.follow': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Follow'},
