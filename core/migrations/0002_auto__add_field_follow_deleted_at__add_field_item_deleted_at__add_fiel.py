...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.deleted_at'
        db.add_column(u'core_item', 'deleted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pin.deleted_at'
        db.add_column(u'core_pin', 'deleted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.deleted_at'
        db.delete_column(u'core_item', 'deleted_at')

        # Deleting field 'Pin.deleted_at'
        db.delete_column(u'core_pin', 'deleted_at')
